...
final class LoginViewModelTests: XCTestCase {
    private let keychain = KeychainStore(service: "ai.multi-casual.app.login-view-model.test")
    private let defaults = UserDefaults(suiteName: "ai.multi-casual.app.login-view-model.test")!
    ...
    override func setUpWithError() throws {
        ...
        #endif
        try? keychain.delete()
        defaults.removePersistentDomain(forName: "ai.multi-casual.app.login-view-model.test")
