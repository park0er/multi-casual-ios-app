...
final class AuthSessionTests: XCTestCase {
    private let store = KeychainStore(service: "ai.multi-casual.app.auth-session.test")
    private let defaults = UserDefaults(suiteName: "ai.multi-casual.app.auth-session.test")!
    ...
    override func setUpWithError() throws {
        ...
        #endif
        try? store.delete()
        defaults.removePersistentDomain(forName: "ai.multi-casual.app.auth-session.test")
    ...
    func test_xiaomiKeychainServiceIsSeparateFromOfficialService() {
        ...
        XCTAssertEqual(AppEnvironment.official.keychainService, "ai.multi-casual.app")
        XCTAssertEqual(AppEnvironment.xiaomi.keychainService, "ai.multi-casual.app.xiaomi")
    }
