...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@multi-casual/ui/components/ui/collapsible";
import { ChevronRight, ChevronDown, Brain, AlertCircle, AlertTriangle } from "lucide-react";
import { useScrollFade } from "@multi-casual/ui/hooks/use-scroll-fade";
import { useAutoScroll } from "@multi-casual/ui/hooks/use-auto-scroll";
import { taskMessagesOptions } from "@multi-casual/core/chat/queries";
import { Markdown } from "@multi-casual/views/common/markdown";
import type { AgentAvailability } from "@multi-casual/core/agents";
import type { ChatMessage, ChatPendingTask, TaskMessagePayload, TaskFailureReason } from "@multi-casual/core/types";
import type { ChatTimelineItem } from "@multi-casual/core/chat";
