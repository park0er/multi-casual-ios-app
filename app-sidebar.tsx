...
import { cn } from "@multi-casual/ui/lib/utils";
...
import { ActorAvatar } from "@multi-casual/ui/components/common/actor-avatar";
import { Tooltip, TooltipTrigger, TooltipContent } from "@multi-casual/ui/components/ui/tooltip";
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from "@multi-casual/ui/components/ui/collapsible";
import { StatusIcon } from "../issues/components/status-icon";
import { useIssueDraftStore } from "@multi-casual/core/issues/stores/draft-store";
import { useCreateModeStore } from "@multi-casual/core/issues/stores/create-mode-store";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
  ...
  SidebarMenuItem,
  SidebarRail,
} from "@multi-casual/ui/components/ui/sidebar";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
  ...
  DropdownMenuTrigger,
} from "@multi-casual/ui/components/ui/dropdown-menu";
import { useAuthStore } from "@multi-casual/core/auth";
import { useCurrentWorkspace, useWorkspacePaths, paths } from "@multi-casual/core/paths";
import { workspaceListOptions, myInvitationListOptions, workspaceKeys } from "@multi-casual/core/workspace/queries";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { inboxKeys, deduplicateInboxItems } from "@multi-casual/core/inbox/queries";
import { api, ApiError } from "@multi-casual/core/api";
import { useModalStore } from "@multi-casual/core/modals";
import { useMyRuntimesNeedUpdate } from "@multi-casual/core/runtimes/hooks";
import { pinListOptions } from "@multi-casual/core/pins/queries";
import { useDeletePin, useReorderPins } from "@multi-casual/core/pins/mutations";
import { issueDetailOptions } from "@multi-casual/core/issues/queries";
import { projectDetailOptions } from "@multi-casual/core/projects/queries";
import type { PinnedItem } from "@multi-casual/core/types";
