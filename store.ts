...
const AGENT_STORAGE_KEY = "multi-casual:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "multi-casual:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "multi-casual:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "multi-casual:chat:width";
const CHAT_HEIGHT_KEY = "multi-casual:chat:height";
const CHAT_EXPANDED_KEY = "multi-casual:chat:expanded";
/** Focus mode is a personal preference — global across workspaces/sessions. */
const FOCUS_MODE_KEY = "multi-casual:chat:focusMode";
/**
 ...
 */
const OPEN_KEY = "multi-casual:chat:isOpen";
